...
namespace WalkingTec.Mvvm.Mvc
{
    ...
    public class _FrameworkController : BaseController
    {
        ...
        public IActionResult Upload(SaveFileModeEnum? sm = null, string groupName = null, bool IsTemprory = true, string _DONOT_USE_CS = "default",bool saveInDb=true)
        {
            CurrentCS = _DONOT_USE_CS ?? "default";
        ...
        [HttpPost]
        [ActionDescription("UploadFileRoute")]
        public IActionResult UploadImage(SaveFileModeEnum? sm = null, string groupName = null, bool IsTemprory = true, string _DONOT_USE_CS = "default", int? width = null, int? height = null,bool saveInDb=true)
        {
            if (width == null && height == null)
            {
                return Upload(sm, groupName, IsTemprory, _DONOT_USE_CS,saveInDb);
            }
            CurrentCS = _DONOT_USE_CS ?? "default";
            var FileData = Request.Form.Files[0];
            sm = sm == null ? ConfigInfo.FileUploadOptions.SaveFileMode : sm;
