...
{
  public  static class HuaWeiFileHelper
    {
        ...
        private static string bucketName = "obs-wnl-images-other";
        private static string objectName = "install.png";

        static HuaWeiFileHelper()
        {
            client = new ObsClient(AK, SK, endpoint);
        }

        public static string PutFileWithStream(Stream fstream, string remoteFileName, string reptxt = "obs-wnl-images-other.obs.cn-north-4.myhuaweicloud.com", string newreptxt = "huaweiyun.other.51wnl-cq.com")
        {
