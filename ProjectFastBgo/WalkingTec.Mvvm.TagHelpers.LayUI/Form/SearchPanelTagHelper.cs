...
");
  ...
  <div style=""text-align:left;margin-top:-50px;"" id=""{tempSearchTitleId}"">
        <a href=""javascript:void(0)"" class=""layui-btn layui-btn-sm"" style=""margin-left:10px"" id=""{SearchBtnId}""><i class=""layui-icon"">&#xe615;</i>搜索</a>
